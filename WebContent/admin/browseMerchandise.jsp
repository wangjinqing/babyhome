...
<center>
	...
	<div class="displayTable">
		<display:table name="${pageList}" id="row" pagesize="${pageSize}" export="true" class="displaytag" requestURI="mer_browseMerchandise.action" >
			<display:column title="${label1}" sortable="true" headerClass="sortable" style="text-align:center;"> 
				${(pageList.pageNumber-1)*pageList.objectsPerPage+row_rowNum} 
			</display:column>
