...
<!--
	...
	//响应"查询按钮"单击事件
	function query(){
		var hqlstr="where 1=1";
		if (document.getElementById("keywords").value!=''){
			hqlstr = hqlstr + " and a."+document.getElementById("keyfield").value+" like '%"+document.getElementById("keywords").value+"%'";
		}
		...
		window.parent.pvMainFrame.location="traffic_browsePV.action?where="+hqlstr;
	}
-->
</script>
</head>
...
<center>
	<div class="titleText"><s:text name="traffic_pv"/></div>
