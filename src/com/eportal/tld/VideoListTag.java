...
public class VideoListTag extends SimpleTagSupport{
	...
	public void doTag() throws JspException, IOException{
    	...
    	while(it.hasNext()){
    		...
    		sb.append("</div>\n");
    		if (mer.getPicture()!=null && mer.getPicture().trim().length()>0){//有商品图片
    			sb.append("<img src='"+baseurl+"/images/play.gif' style='cursor:pointer' onclick=\"playFlv('"+baseurl+mer.getPicture()+"','"+baseurl+mer.getVideo()+"')\"/>\n");
    		}else{//无商品图片
    			sb.append("<img src='"+baseurl+"/images/play.gif' style='cursor:pointer' onclick=\"playFlv('"+baseurl+"/images/cover.jpg','"+baseurl+mer.getVideo()+"')\"/>\n");
    		}    		
